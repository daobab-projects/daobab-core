...
public interface DaobabProperty {
    ...
    String GENERATOR_USE_SCHEMA_INTO_TABLE_NAME = "daobab.generator.schema.tablename";
    String GENERATOR_OVERRIDE = "daobab.generator.override";
    String GENERATOR_TS = "daobab.generator.generate.typescript";
    String GENERATOR_TABLES = "daobab.generator.generate.tables";
