...
public abstract class Index<E extends Entity, F> {
    ...
    public Index(Column<E, ?, RelatedTo> indexedColumn, EntitiesBufferIndexed<E> buffer) {
        ...
        log.info("Index created for column {}, Total elements: {} indexed size: {}. Index considered as {}", indexedColumn.entityClass().getName() + "." + indexedColumn.getColumnName(), buffer.size(), indexSize, worthless ? "worthless" : "useful");
    }
