...
/**
 * A mix-in of the Microsoft SQL Server functions: each method builds a
 ...
 *   .findMany();
 * }</pre>
 * The function names come from {@link io.daobab.statement.function.dictionary.DictFunctionMicrosoftSql}.
 *
