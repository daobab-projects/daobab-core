...
public interface FunctionWhispererBuffer {
    ...
    default <E extends Entity, F, R extends RelatedTo> ColumnFunction<E, F, R, Long> countAll() {
        return new ColumnFunction<>((Column<E, F, R>) DummyColumnTemplate.dummyColumn("countAll"), DictFunctionBuffer.COUNT, Long.class);
    }

    default <E extends Entity, F, R extends RelatedTo> ColumnFunction<E, F, R, Long> distinct(ColumnOrQuery<E, F, R> columnOrQuery) {
    ...
    default <E extends Entity, F, R extends RelatedTo> ColumnFunction<E, F, R, String> sum(ColumnOrQuery<E, F, R> columnOrQuery) {
        return new ColumnFunction<>(columnOrQuery, DictFunctionBuffer.SUM, String.class);
    }

    default <E extends Entity, F, R extends RelatedTo> ColumnFunction<E, F, R, String> max(ColumnOrQuery<E, F, R> columnOrQuery) {
        return new ColumnFunction<>(columnOrQuery, DictFunctionBuffer.MAX, String.class);
    }

    default <E extends Entity, F, R extends RelatedTo> ColumnFunction<E, F, R, String> min(ColumnOrQuery<E, F, R> columnOrQuery) {
        return new ColumnFunction<>(columnOrQuery, DictFunctionBuffer.MIN, String.class);
    }

    default <E extends Entity, F, R extends RelatedTo> ColumnFunction<E, F, R, String> avg(ColumnOrQuery<E, F, R> columnOrQuery) {
    ...
    default <E extends Entity, F, R extends RelatedTo> ColumnFunction<E, F, R, String> year(ColumnOrQuery<E, F, R> columnOrQuery) {
        return new ColumnFunction<>(columnOrQuery, DictFunctionBuffer.YEAR, String.class);
    }

    default ColumnFunction<Dual, Date, RelatedTo, Date> currentDate() {
        return new ColumnFunction<>(DummyColumnTemplate.dummyEntityDateColumn(new Dual(), ""), DictFunctionBuffer.CURRENT_DATE);
    }

    default <E extends Entity> ColumnFunction<E, Date, RelatedTo, Date> currentDate(E entity) {
