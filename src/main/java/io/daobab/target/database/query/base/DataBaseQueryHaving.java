...
//    }
    ...
    default <E extends Entity, F, R extends RelatedTo> Q havingEqual(Column<E, F, R> column, DaoParam val) {
        setHavingWrapper(new DataBaseHavingAnd().equal(column, val));
        return (Q) this;
    }

    default <E extends Entity, F, R extends RelatedTo> Q havingNotEqual(Column<E, F, R> column, DaoParam val) {
        setHavingWrapper(new DataBaseHavingAnd().notEqual(column, val));
        return (Q) this;
    }

    default <E extends Entity, F, R extends RelatedTo> Q havingGreater(Column<E, F, R> column, DaoParam val) {
        setHavingWrapper(new DataBaseHavingAnd().greater(column, val));
        return (Q) this;
    }

    default <E extends Entity, F, R extends RelatedTo> Q havingGreaterOrEqual(Column<E, F, R> column, DaoParam val) {
        setHavingWrapper(new DataBaseHavingAnd().greaterOrEqual(column, val));
        return (Q) this;
    }

    default <E extends Entity, F, R extends RelatedTo> Q havingLess(Column<E, F, R> column, DaoParam val) {
        setHavingWrapper(new DataBaseHavingAnd().less(column, val));
        return (Q) this;
    }

    default <E extends Entity, F, R extends RelatedTo> Q havingLessOrEqual(Column<E, F, R> column, DaoParam val) {
        setHavingWrapper(new DataBaseHavingAnd().lessOrEqual(column, val));
        return (Q) this;
    }

    default <E extends Entity, F, R extends RelatedTo> Q havingLike(Column<E, F, R> column, DaoParam val) {
        setHavingWrapper(new DataBaseHavingAnd().like(column, val));
        return (Q) this;
    }

    default <E extends Entity, F, R extends RelatedTo> Q havingInCollectionParam(Column<E, F, R> column, Collection<DaoParam> val) {
        setHavingWrapper(new DataBaseHavingAnd().inFieldsParam(column, val));
        return (Q) this;
    }

    default <E extends Entity, F, R extends RelatedTo> Q havingNotInCollectionParam(Column<E, F, R> column, Collection<DaoParam> val) {
        setHavingWrapper(new DataBaseHavingAnd().notInFieldsParam(column, val));
        return (Q) this;
    }

    default <E extends Entity, F, R extends RelatedTo> Q havingInFieldsParam(Column<E, F, R> column, Collection<DaoParam> val) {
        setHavingWrapper(new DataBaseHavingAnd().inFieldsParam(column, val));
        return (Q) this;
    }

    default <E extends Entity, F, R extends RelatedTo> Q havingNotInFieldsParam(Column<E, F, R> column, Collection<DaoParam> val) {
        setHavingWrapper(new DataBaseHavingAnd().notInFieldsParam(column, val));
        return (Q) this;
    }
