...
public class TypeConverterPrimaryKeyToOneCache<F, E extends Entity & PrimaryKey<E, F, ?>> extends TypeConverterPKBased<F, E> implements EntityConverter<F, E>,  KeyableCache<F, E> {
