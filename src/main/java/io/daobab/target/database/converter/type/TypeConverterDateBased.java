 ...
 *
 * @param <T> the Daobab column type produced from the {@code Date} database value
 * @author Klaudiusz Wojtkowiak, (C) Elephant Software
 */
public abstract class TypeConverterDateBased<T> implements DatabaseTypeConverter<Date, T> {
